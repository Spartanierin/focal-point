...
Skins.Builtin.default = Skins.Builtin.default or {
    ...
    brand = {
        ...
        orangeSoft = { 0.918, 0.459, 0.000, 0.22 },
        orangeMedium = { 0.918, 0.459, 0.000, 0.38 },
        orangeStrong = { 0.918, 0.459, 0.000, 0.85 },
        titleFocal = {
            hex = "FFFFFF",
            wow = "|cffFFFFFF",
            r = 1.000,
    ...
    formPalette = {
        Chrome = {
            ...
            sectionAccent = { 0.918, 0.459, 0.000, 0.24 },
            headerAccent = { 0.918, 0.459, 0.000, 0.38 },
    ...
    editorButtonVisuals = {
        states = {
            ...
            hover = {
                fill = { 0.12, 0.13, 0.15, 0.96 },
                border = { 0.918, 0.459, 0.000, 0.75 },
                accent = { 0.918, 0.459, 0.000, 0.16 },
                text = { 1.00, 0.96, 0.90, 1.00 },
            },
            pressed = {
                fill = { 0.14, 0.09, 0.05, 0.96 },
                border = { 0.918, 0.459, 0.000, 0.82 },
                accent = { 0.918, 0.459, 0.000, 0.22 },
                text = { 1.00, 0.95, 0.88, 1.00 },
            },
            active = {
                fill = { 0.18, 0.12, 0.07, 0.96 },
                border = { 0.918, 0.459, 0.000, 0.95 },
                accent = { 0.918, 0.459, 0.000, 0.22 },
                text = { 1.00, 0.95, 0.88, 1.00 },
            },
        },
