...
ns.GUI.Layouts.UnitFrame.FrameTab = {
    ...
    },
    {
        ...
        layout = "list",
        items = {
            { widget = "slider",   path = { "Units", "$unitKey", "width" },         label = "OPTION_WIDTH",        description = "OPTION_WIDTH_DESC",        min = 50,    max = 600,  step = 1,    fallback = 220, format = "%d" },
            { widget = "slider",   path = { "Units", "$unitKey", "height" },        label = "OPTION_HEIGHT",       description = "OPTION_HEIGHT_DESC",       min = 10,    max = 200,  step = 1,    fallback = 45,  format = "%d" },
            { widget = "slider",   path = { "Units", "$unitKey", "x" },             label = "OPTION_X_OFFSET",     description = "OPTION_X_OFFSET_DESC",     min = -1000, max = 1000, step = 1,    fallback = 0,   format = "%d" },
            { widget = "slider",   path = { "Units", "$unitKey", "y" },             label = "OPTION_Y_OFFSET",     description = "OPTION_Y_OFFSET_DESC",     min = -1000, max = 1000, step = 1,    fallback = 0,   format = "%d" },
            { widget = "dropdown", path = { "Units", "$unitKey", "point" },         label = "OPTION_ANCHOR_FROM",  description = "OPTION_ANCHOR_FROM_DESC",  list = "anchorPoints", fallback = "CENTER" },
            { widget = "dropdown", path = { "Units", "$unitKey", "relativePoint" }, label = "OPTION_ANCHOR_TO",    description = "OPTION_ANCHOR_TO_DESC",    list = "anchorPoints", fallback = "CENTER" },
        },
    },
    {
        ...
        layout = "list",
        items = {
            { widget = "slider", path = { "Units", "$unitKey", "alpha" }, label = "OPTION_ALPHA", description = "OPTION_ALPHA_DESC", min = 0.0, max = 1.0, step = 0.01, fallback = 1.0, format = "%.2f" },
            { widget = "slider", path = { "Units", "$unitKey", "scale" }, label = "OPTION_SCALE", description = "OPTION_SCALE_DESC", min = 0.5, max = 2.0, step = 0.01, fallback = 1.0, format = "%.2f" },
        },
    },
    {
