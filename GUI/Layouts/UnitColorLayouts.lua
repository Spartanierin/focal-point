...
ns.GUI.Layouts.UnitColors.ColorTab = {
    ...
    },
    {
        ...
        items = {
            ...
            { widget = "checkbox", path = { "Units", "$unitKey", "enableHealthColorFade" }, label = "OPTION_HEALTH_COLOR_FADE", description = "OPTION_HEALTH_COLOR_FADE_DESC", fallback = false, resetText = false, disabled = "unit", refreshGUI = true, onChanged = "refresh_health_fade" },
            { widget = "colorpicker", path = { "Units", "$unitKey", "healthFadeTargetColor" }, label = "OPTION_HEALTH_COLOR_FADE_TARGET", description = "OPTION_HEALTH_COLOR_FADE_TARGET_DESC", hasAlpha = true, disabled = "healthFadeTarget" },
