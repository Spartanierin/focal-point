...
ns.GUI.Layouts.TextBuilder.Form = {
    ...
    },
    {
        ...
        items = {
            { id = "templateTitle", widget = "label", itemVariant = "section_title_large", textKey = "INFO_TEXT_BUILDER_TEMPLATE" },
            ...
            { id = "updateButton", widget = "button", itemVariant = "secondary_action", textKey = "INFO_TEXT_BUILDER_APPLY", width = 240, fullWidth = false },
        },
    },
    {
        section = "Preview",
        ...
        items = {
            { id = "previewTitle", widget = "label", itemVariant = "section_title_large", textKey = "INFO_TEXT_BUILDER_PREVIEW" },
    ...
    },
    {
        ...
        items = {
            { id = "templatesTitle", widget = "label", itemVariant = "section_title_large", textKey = "INFO_TEXT_BUILDER_TEMPLATES" },
    ...
    },
    {
        ...
        items = {
            { id = "usageTitle", widget = "label", itemVariant = "section_title_large", textKey = "INFO_TEXT_BUILDER_TEMPLATE_USAGE" },
