...
ns.GUI.Layouts.FormElements = {
    ...
    ButtonStyles = {
        primary = {
            ...
            height = 24,
            textRole = "label",
            textColor = { 1.00, 0.95, 0.88, 1.00 },
            normal = { 0.18, 0.12, 0.07, 0.98 },
            pushed = { 0.14, 0.09, 0.05, 0.98 },
            highlight = { 0.22, 0.14, 0.08, 0.98 },
            disabled = { 0.14, 0.12, 0.10, 0.82 },
        },
        secondary = {
            sidebarVariant = "secondary",
            height = 22,
            textRole = "label",
            textColor = { 0.94, 0.96, 0.98, 1.00 },
            normal = { 0.10, 0.12, 0.15, 0.96 },
            pushed = { 0.08, 0.10, 0.13, 0.98 },
            highlight = { 0.13, 0.15, 0.18, 0.98 },
    ...
    ComponentStyles = {
        Actions = {
            ...
            SecondaryAction = { buttonStyle = "secondary", variant = "default", sidebarVariant = "secondary" },
            UtilityAction = {
                buttonStyle = "secondary",
                variant = "utility",
                sidebarVariant = "utility",
                sidebarVariants = { quiet = "quiet_utility" },
            },
            DestructiveAction = { buttonStyle = "danger", variant = "danger" },
            ToolbarAction = { buttonStyle = "toolbar_secondary", variant = "default", sidebarVariant = "utility" },
        },
        Navigation = {
            NavigationItem = { buttonStyle = "secondary", variant = "default" },
            UnitNavigatorItem = {
                styleOwner = "EditorSidebarThemeHelpers",
                variant = "navigator",
                states = {
                    disabled = {
                        fill = { 0.045, 0.052, 0.064, 0.90 },
                        border = { 0.12, 0.145, 0.18, 0.50 },
                        accent = { 0.32, 0.40, 0.50, 0.02 },
                        text = { 0.35, 0.39, 0.44, 1.00 },
                    },
                    normal = {
                        fill = { 0.052, 0.062, 0.078, 0.96 },
                        border = { 0.14, 0.18, 0.23, 0.62 },
                        accent = { 0.42, 0.56, 0.72, 0.00 },
                        text = { 0.34, 0.38, 0.43, 1.00 },
                    },
                    hover = {
                        fill = { 0.068, 0.084, 0.108, 0.97 },
                        border = { 0.22, 0.29, 0.37, 0.70 },
                        accent = { 0.44, 0.59, 0.76, 0.05 },
                        text = { 0.70, 0.76, 0.84, 1.00 },
                    },
                    pressed = {
                        fill = { 0.060, 0.075, 0.098, 0.98 },
                        border = { 0.25, 0.33, 0.42, 0.76 },
                        accent = { 0.48, 0.64, 0.82, 0.08 },
                        text = { 0.73, 0.79, 0.87, 1.00 },
                    },
                    active = {
                        fill = { 0.325, 0.200, 0.090, 0.98 },
                        border = { 0.65, 0.44, 0.20, 0.92 },
                        accent = { 0.84, 0.61, 0.30, 0.56 },
                        text = { 0.98, 0.96, 0.91, 1.00 },
                    },
                },
            },
        },
