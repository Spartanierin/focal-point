    ...
    ComponentStyles = {
        ...
        Navigation = {
            ...
            UnitNavigatorItem = {
                ...
                states = {
                    disabled = {
                        fill = { 0.055, 0.065, 0.080, 0.92 },
                        border = { 0.14, 0.17, 0.21, 0.58 },
                        accent = { 0.32, 0.40, 0.50, 0.04 },
                        text = { 0.42, 0.47, 0.53, 1.00 },
                    },
                    normal = {
                        fill = { 0.070, 0.085, 0.105, 0.98 },
                        border = { 0.18, 0.22, 0.28, 0.78 },
                        accent = { 0.42, 0.56, 0.72, 0.02 },
                        text = { 0.72, 0.77, 0.84, 1.00 },
                    },
                    hover = {
                        fill = { 0.095, 0.125, 0.165, 0.98 },
                        border = { 0.30, 0.39, 0.50, 0.84 },
                        accent = { 0.44, 0.59, 0.76, 0.10 },
                        text = { 0.86, 0.91, 0.97, 1.00 },
                    },
                    pressed = {
                        fill = { 0.080, 0.110, 0.150, 0.98 },
                        border = { 0.34, 0.44, 0.57, 0.88 },
                        accent = { 0.48, 0.64, 0.82, 0.16 },
                        text = { 0.88, 0.93, 0.98, 1.00 },
                    },
                    active = {
                        fill = { 0.135, 0.195, 0.265, 0.98 },
                        border = { 0.40, 0.54, 0.69, 0.92 },
                        accent = { 0.54, 0.71, 0.88, 0.58 },
